...
public class LambdaController : MonoBehaviour {
...
//			Debug.Log(transform.rotation.ToString());
		...
		{
			gina["idlle"].speed = Random.Range(0.2f, 1.8f);
			Debug.Log("RIGHT ARROW UP");
			gina.CrossFade("idlle");
